...
const HomePage: React.FC = () => {
  ...
  const getClosestTrip = () => {
    ...
    const upcomingTrips = getUpcomingTrips().map((trip) => {
  ...
  const getRequestedTrips = () => {
    ...
    return TripsData.filter((trip) =>
      trip.passengers.some(
        (passenger) =>
          passenger.driver.id === user?.uid &&
          !trip.passengers.some((passenger) => passenger.status === "confirmed")
      )
    );
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.headerSubText}>
          Plan, Join, and Enjoy Your Trips
        </Text>
      </LinearGradient>
          ...
          {isLoading ? (
            ...
            <>
              <RideCard
                ...
                data={getClosestTrip()}
                onPress={() =>
                  router.push(`/(tabs)/(trips)/${getClosestTrip().id}`)
                }
              />
